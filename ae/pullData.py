'''
This script is written for Valentin Aslanyan to support his Alfven eigenmode studies using Alcator C-Mod data.
He will initially analyze data that Jason Sears had organized and commissioned in his Active MHD studies.

T. Golfinopoulos, 17 Nov. 2017
'''
from MDSplus import *
